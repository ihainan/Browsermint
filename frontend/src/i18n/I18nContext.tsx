  ...
  en: {
    ...
    sessionView: {
      ...
      connect: {
        ...
        openclawHint: "Restart the **OpenClaw Gateway** after saving. [Learn how OpenClaw connects via Remote CDP](https://docs.openclaw.ai/tools/browser#direct-websocket-cdp-providers)",
  ...
  zh: {
    ...
    sessionView: {
      ...
      connect: {
        ...
        openclawHint: "保存后需重启 **OpenClaw Gateway** 方可生效。[了解如何通过 Remote CDP 连接云端浏览器](https://docs.openclaw.ai/tools/browser#direct-websocket-cdp-providers)",
