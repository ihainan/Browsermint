  ...
  en: {
    ...
    sessionView: {
      ...
      connect: {
        ...
        hermesHint: "After saving, run `/reload-mcp` inside Hermes chat to pick up the new server. This token is **temporary** — fetch a fresh CDP URL before each agent run.",
  ...
  zh: {
    ...
    sessionView: {
      ...
      connect: {
        ...
        hermesHint: "保存后在 Hermes 对话中执行 `/reload-mcp` 使配置生效。Token 为**临时凭证**，每次运行 Agent 前请重新获取 CDP 地址。",
