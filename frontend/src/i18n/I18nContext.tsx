  ...
  en: {
    ...
    sessionView: {
      ...
      connect: {
        ...
        hermesConfigCli: "**Option 1** — add via CLI",
        hermesConfig: "**Option 2** — add to `~/.hermes/config.yaml` under `mcp_servers`",
  ...
  zh: {
    ...
    sessionView: {
      ...
      connect: {
        ...
        hermesConfigCli: "**方式一** — 通过 CLI 添加",
        hermesConfig: "**方式二** — 写入 `~/.hermes/config.yaml` 的 `mcp_servers` 字段",
