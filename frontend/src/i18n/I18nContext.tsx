  ...
  en: {
    ...
    sessionView: {
      ...
      connect: {
        ...
        openclawHint: "Restart the **OpenClaw Gateway** after saving. This token is **temporary** — fetch a fresh CDP URL before each agent run. [Learn how OpenClaw connects via Remote CDP](https://docs.openclaw.ai/tools/browser)",
  ...
  zh: {
    ...
    sessionView: {
      ...
      connect: {
        ...
        openclawHint: "保存后需重启 **OpenClaw Gateway** 方可生效。Token 为**临时凭证**，每次运行 Agent 前请重新获取 CDP 地址。[了解如何通过 Remote CDP 连接云端浏览器](https://docs.openclaw.ai/tools/browser)",
