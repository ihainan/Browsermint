...
const messages = {
  en: {
    common: {
      ...
      invalidUsername: "Username must be 3–64 characters and contain only letters, numbers, and underscores",
      password: "Password",
      username: "Username",
      cancel: "Cancel",
      create: "Create",
    ...
    overview: {
      ...
      totalOnlineTime: "Total Online",
      topSessions: "Browser Online Time",
      topSessionsSubtitle: "Top sessions by online time",
      noOnlineData: "No online time recorded yet",
      ...
      capsolverTitle: "Auto Captcha Solver",
    ...
    sessions: {
      ...
      browserNameTooLong: "Browser name must be 64 characters or fewer",
    ...
    sessionView: {
      ...
      enableInteraction: "Unlock",
      disableInteraction: "Lock",
      ...
      connect: {
        ...
        openclawIntro: "Connect this browser to **OpenClaw** via the **chrome-devtools MCP** server.",
        openclawConfigCli: "**Option 1** — add via CLI",
        openclawConfig: "**Option 2** — add to `~/.openclaw/openclaw.json`",
        openclawHint: "This token is **temporary** and expires when the session ends. Fetch a fresh CDP URL before each agent run.",
        ...
        hermesIntro: "Connect this browser to **Hermes Agent** via the **chrome-devtools MCP** server.",
        hermesConfig: "Add to `~/.hermes/config.yaml` under `mcp_servers`",
        hermesHint: "After adding, run `/reload-mcp` inside Hermes chat to pick up the new server. This token is **temporary** — fetch a fresh CDP URL before each agent run.",
  ...
  zh: {
    common: {
      ...
      invalidUsername: "用户名只能包含字母、数字和下划线，长度为 3–64 位",
      password: "密码",
      username: "用户名",
      cancel: "取消",
      create: "创建",
    ...
    overview: {
      ...
      topSessions: "浏览器在线时长",
      topSessionsSubtitle: "在线时长最长的 Session",
      noOnlineData: "暂无在线时长数据",
      ...
      capsolverTitle: "自动验证码解决",
      capsolverSuccess: "成功",
      capsolverFailed: "失败",
      capsolverAvgTime: "平均耗时",
      capsolverNoData: "暂无自动验证码解决记录",
    },
    browsers: {
      title: "浏览器",
      filterStatus: "状态",
    ...
    sessions: {
      ...
      browserNameTooLong: "浏览器名称不能超过 64 个字符",
    ...
    sessionView: {
      ...
      enableInteraction: "解锁交互",
      disableInteraction: "退出交互",
      reloadBrowser: "刷新浏览器",
      fullscreen: "全屏",
      tabDetails: "详情",
      tabLogs: "日志",
      ...
      connect: {
        ...
        sessionIdLabel: "Session ID",
        openclawIntro: "通过 **chrome-devtools MCP** 服务器将此浏览器接入 **OpenClaw**。",
        openclawConfigCli: "**方式一** — 通过 CLI 添加",
        openclawConfig: "**方式二** — 写入 `~/.openclaw/openclaw.json`",
        openclawHint: "Token 为**临时凭证**，会话结束后自动失效。每次运行 Agent 前请重新获取 CDP 地址。",
        ...
        hermesIntro: "通过 **chrome-devtools MCP** 服务器将此浏览器接入 **Hermes Agent**。",
        hermesConfig: "写入 `~/.hermes/config.yaml` 的 `mcp_servers` 字段",
        hermesHint: "添加后在 Hermes 对话中执行 `/reload-mcp` 使配置生效。Token 为**临时凭证**，每次运行 Agent 前请重新获取 CDP 地址。",
